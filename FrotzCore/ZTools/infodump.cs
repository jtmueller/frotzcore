...
namespace ZTools
{
    public static class InfoDump
    {
        ...
        private static System.Collections.Generic.List<ZToolInfo> ProcessStory(byte[] storyFile, int[] options, int columns, int symbolic)
        {
        ...
        private readonly struct AreaComparer : System.Collections.Generic.IComparer<AreaT>
        {
