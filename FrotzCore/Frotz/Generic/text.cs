...
namespace Frotz.Generic
{
    internal static class Text
    {
         ...
         *   Sat Apr 21, 2001
         */
        // NOTE: following construct is optimized by compiler into direct binary lookup
        private static ReadOnlySpan<zword> zscii_to_latin1 => new zword[] {
        ...
        // NOTE: following construct is optimized by compiler into direct binary lookup
        private static ReadOnlySpan<zword> tolower_basic_latin => new zword[] { // 0x100
        ...
        private static ReadOnlySpan<zword> tolower_latin_extended_a => new zword[] { // 0x80
        ...
        private static ReadOnlySpan<zword> tolower_greek => new zword[] { //0x50
        ...
        private static ReadOnlySpan<zword> tolower_cyrillic => new zword[] { // 0x60
