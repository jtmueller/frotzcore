...
namespace Frotz.Generic
{
    internal static class Screen
    {
        ...
        internal static void ZMouseWindow()
        {
        ...
        internal static void ZSetWindow()
        {
            SetWindow(WinArg0());
        }/* z_set_window */
        ...
        internal static void ZSplitWindow()
        {
            SplitWindow(Process.zargs[0]);
        }/* z_split_window */
