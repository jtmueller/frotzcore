...
internal static class Process
{
    ...
    internal static readonly ZInstruction[] op0_opcodes = [
        new(ZRTrue),
        new(ZRFalse),
        new(Text.ZPrint),
        new(Text.ZPrintRet),
    ...
    internal static readonly ZInstruction[] op1_opcodes = [
        new(Math.ZJz),
    ...
    internal static readonly ZInstruction[] var_opcodes = [
        new(__illegal__),
        new(Math.ZJe),
        new(Math.ZJl),
        new(Math.ZJg),
    ...
    internal static readonly ZInstruction[] ext_opcodes = [
        new(FastMem.ZSave),
        new(FastMem.ZRestore),
        new(Math.ZLogShift),
